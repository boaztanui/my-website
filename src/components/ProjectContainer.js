        ...
        <ProjectContainerContainer id='projects'>
            ...
            <ProjectBox>
                <Projects
                    ...
                    content='This project was all about fetching data from an API using React Hooks and displaying the movies in a UI same as Netflix.  I used Styled components for styling, utilised material UI for icons, React-router and deployed it to production on Firebase'
                ...
                <Projects
                    ...
                    content='I created a React app to showcase my work and skills.  I used React Components to divide each section into single components. I used Styled components for styling this App. I also deployed it on firebase'
                ...
                <Projects
                    ...
                    img={TinderClone}
                    header='Tinder Clone'
                    content='This project was built with a purpose of connecting the React frontend with Node Backend. I used MongoDB, Express and Node.js for the backend and storing of Data. The App had most functionalities of Tinder App'
                ...
                <Projects
                    ...
                    img={TeslaClone}
                    header='Tesla Clone'
                    content='This project was about Designing the framework of Tesla using React. It was so amazing to use different animations in various sections of the APP I used react Hooks, Css3, Styled Components and deployed it to production on Firebase'
                ...
                <Projects
                    ...
                    content='This was one of my largest build I created on an online bootcamp. The Goal was to design an Ecommerce website with all the functionalities working including making payments, login with google and deployed it to production on Firebase'
